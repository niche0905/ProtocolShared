...
const ::_pbi::DescriptorTable descriptor_table_game_2fgame_5fenums_2eproto = {
    ...
    nullptr, file_level_enum_descriptors_game_2fgame_5fenums_2eproto,
    file_level_service_descriptors_game_2fgame_5fenums_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_game_2fgame_5fenums_2eproto_getter() {
  return &descriptor_table_game_2fgame_5fenums_2eproto;
}
