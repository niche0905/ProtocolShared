...
static ::_pb::Metadata file_level_metadata_lobby_2ftypes_2eproto[3];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_lobby_2ftypes_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_lobby_2ftypes_2eproto = nullptr;

const uint32_t TableStruct_lobby_2ftypes_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_lobby_2ftypes_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021lobby/types.proto\022\010se.lobby\032\031common/co"
  "mmon_types.proto\"X\n\rPlayerProfile\022&\n\tpla"
  "yer_id\030\001 \001(\0132\023.se.common.EntityId\022\020\n\010nic"
  "kname\030\002 \001(\t\022\r\n\005level\030\003 \001(\r\" \n\013MatchTicke"
  "t\022\021\n\tticket_id\030\001 \001(\004\"3\n\014RoomEndpoint\022\017\n\007"
  "room_id\030\003 \001(\004\022\022\n\njoin_token\030\004 \001(\tb\006proto"
  "3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_lobby_2ftypes_2eproto_deps[1] = {
  &::descriptor_table_common_2fcommon_5ftypes_2eproto,
};
static ::_pbi::once_flag descriptor_table_lobby_2ftypes_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_lobby_2ftypes_2eproto = {
    false, false, 241, descriptor_table_protodef_lobby_2ftypes_2eproto,
    "lobby/types.proto",
    &descriptor_table_lobby_2ftypes_2eproto_once, descriptor_table_lobby_2ftypes_2eproto_deps, 1, 3,
    schemas, file_default_instances, TableStruct_lobby_2ftypes_2eproto::offsets,
    file_level_metadata_lobby_2ftypes_2eproto, file_level_enum_descriptors_lobby_2ftypes_2eproto,
    file_level_service_descriptors_lobby_2ftypes_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_lobby_2ftypes_2eproto_getter() {
  return &descriptor_table_lobby_2ftypes_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_lobby_2ftypes_2eproto(&descriptor_table_lobby_2ftypes_2eproto);
namespace se {
namespace lobby {
...
::PROTOBUF_NAMESPACE_ID::Metadata PlayerProfile::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_lobby_2ftypes_2eproto_getter, &descriptor_table_lobby_2ftypes_2eproto_once,
      file_level_metadata_lobby_2ftypes_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata MatchTicket::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_lobby_2ftypes_2eproto_getter, &descriptor_table_lobby_2ftypes_2eproto_once,
      file_level_metadata_lobby_2ftypes_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata RoomEndpoint::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_lobby_2ftypes_2eproto_getter, &descriptor_table_lobby_2ftypes_2eproto_once,
      file_level_metadata_lobby_2ftypes_2eproto[2]);
}
